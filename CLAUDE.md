...
* **No Broken or Redirecting Buttons:** Every button, tab, and link must point to a valid, working route or trigger a defined modal/action. Never use dummy query params like `?tab=timeline` unless the target view actively handles them.
